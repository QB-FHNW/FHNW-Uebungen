...
class Fenster(QMainWindow):
    def __init__(self):
        ...
        showOnMap = QAction('Show on map', self)
        showOnMap.trigger.connect(self.buttonShowOnMap_clicked)
    ...
    def buttonSave_clicked(self):
        ...
        with open("output.txt", "a", encoding="utf-8") as file:         # das a steht für append, also hinzufügen (ohne zu löschen wie möglicherweise bei write)
    ...
    def buttonShowOnMap_clicked(self):
